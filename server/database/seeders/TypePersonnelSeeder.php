...
class TypePersonnelSeeder extends Seeder
{
    ...
    {
        $types = [
            ['code' => 200, 'laboral_relationship' => 'Personal Fijo', 'type_personal' => 'Administrativo', 'name' => 'Personal Administrativo No Descentralizado', 'source_budget' => 'Ejecutivo Regional'],
            ['code' => 201, 'laboral_relationship' => 'Personal Fijo', 'type_personal' => 'Médico', 'name' => 'Personal Médico No Descentralizado', 'source_budget' => 'Ejecutivo Regional'],
            ['code' => 202, 'laboral_relationship' => 'Personal Fijo', 'type_personal' => 'Obrero', 'name' => 'Personal Obrero No Descentralizado', 'source_budget' => 'Ejecutivo Regional'],
            ...
            ['code' => 211, 'laboral_relationship' => 'Personal Fijo', 'type_personal' => 'Enfermera', 'name' => 'Personal Enfermera No Descentralizado', 'source_budget' => 'Ejecutivo Regional'],
            ['code' => 212, 'laboral_relationship' => 'Personal Contratado', 'type_personal' => 'Enfermera', 'name' => 'Personal Contratado Enfermera No Descentralizado', 'source_budget' => 'Ejecutivo Regional'],
            ...
            ['code' => 234, 'laboral_relationship' => 'Jubilado', 'type_personal' => 'Obrero', 'name' => 'Personal Obrero Jubilados No Descentralizados', 'source_budget' => 'Ejecutivo Regional'],
            ['code' => 235, 'laboral_relationship' => 'Pensionado', 'type_personal' => 'Obrero', 'name' => 'Personal Obrero Pensionados No Descentralizados', 'source_budget' => 'Ejecutivo Regional'],
            ['code' => 236, 'laboral_relationship' => 'Jubilado', 'type_personal' => 'Administrativo', 'name' => 'Personal Administrativo Jubilados No Descentralizados', 'source_budget' => 'Ejecutivo Regional'],
            ['code' => 237, 'laboral_relationship' => 'Pensionado', 'type_personal' => 'Administrativo', 'name' => 'Personal Administrativo Pensionado No Descentralizados', 'source_budget' => 'Ejecutivo Regional'],
            ...
            ['code' => 240, 'laboral_relationship' => 'Personal Contratado', 'type_personal' => 'Administrativo', 'name' => 'Personal Contratado Administrativo No Descentralizado', 'source_budget' => 'Ejecutivo Regional'],
            ['code' => 241, 'laboral_relationship' => 'Personal Contratado', 'type_personal' => 'Médico', 'name' => 'Personal Contratado Médico No Descentralizado', 'source_budget' => 'Ejecutivo Regional'],
            ['code' => 242, 'laboral_relationship' => 'Personal Contratado', 'type_personal' => 'Obrero', 'name' => 'Personal Contratado Obrero No Descentralizado', 'source_budget' => 'Ejecutivo Regional'],
            ...
            ['code' => 257, 'laboral_relationship' => 'Sobreviviente', 'type_personal' => 'Sobreviviente', 'name' => 'Pensionados Sobrevivientes No Descentralizados', 'source_budget' => 'Ejecutivo Regional'],
